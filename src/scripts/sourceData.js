...
const client = contentful.createClient({
    space: 'v1swvshhhllj', // Insert Contentful Space ID
    accessToken: 'WitCd02DvuHXrnoXR8U0mwPChkrnJs5GAKutdzOeBS4' // Insert Contentful Content Delivery API access token
});
